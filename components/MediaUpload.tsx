...
export const MediaUpload: React.FC<MediaUploadProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {uploadProgress && (
        <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg flex flex-col gap-2 animate-pulse">
          <div className="flex items-center justify-between text-sm font-medium text-blue-700 dark:text-blue-300">
            <span className="flex items-center gap-2">
              ...
              Optimizando y cargando archivos...
            </span>
          ...
          <p className="text-xs text-theme-muted">
            Procesando archivo {uploadProgress.current + 1} de {uploadProgress.total} (compresión local activa ⚡)
          </p>
        </div>
      )}
